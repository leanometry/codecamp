...
var apiProxyFactory = rewire('../lib/api-proxy');
var url = require('url');
...
proxy = apiProxyFactory('https://api.mongolab.com/api/1/databases','4fb51e55e4b02e56a67b0b66');
